...
set SteeringManager:PitchTS to 2. //tuning value for pitch control adjustments, default 2

set SteeringManager:YawTS to 2. //tuning value for yaw control adjustments, default 2

set SteeringManager:RollTS to 2. //tuning value for roll control adjustments, default 2
