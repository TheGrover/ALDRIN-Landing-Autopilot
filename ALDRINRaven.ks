...
set SteeringManager:PitchTS to 2. //tuning value for pitch control adjustments

set SteeringManager:YawTS to 2. //tuning value for yaw control adjustments

set SteeringManager:RollTS to 2. //tuning value for roll control adjustments
...
//set SteeringManager:PitchTorqueAdjust to 0.05. //the torque generated by the RCS system in the pitch direction; from RCS Build Aid 0.103

//set SteeringManager:YawTorqueAdjust to 0.05. //the torque generated by the RCS system in the yaw direction; from RCS Build Aid 0.103

set SteeringManager:ROLLTorqueAdjust to 0.1. //the torque generated by the RCS system in the roll direction; from RCS Build Aid 0.199